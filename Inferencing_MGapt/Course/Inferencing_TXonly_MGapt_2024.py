...
prior = {'k_forward' : ['gaussian', k_rnapbF1, 10, 'positive'],
        'k_forward1' : ['gaussian', k_rnapbF2, 3, 'positive'],
        'k_forward2' : ['gaussian', k_rnapbF3, 8, 'positive'], 
        'k_forward3' : ['gaussian', k_start, 6, 'positive'],
        'k_forward4' : ['gaussian', k_ntpbound, 1.5, 'positive'],
        'k_forward5' : ['gaussian', k_ntpadd, 50, 'positive'],
        'k_forward6' : ['gaussian', k_ntpdis, 1000, 'positive'],
        'k_forward7' : ['gaussian', k_term, 30, 'positive'],
        }
